...

{
	...
	public class FirstPersonController : MonoBehaviour
	{
		...
		{
			if (_inputController.LookMode == LookModes.Cursor || _inputController.LookEnabled == false) return;
		...
		private void Move()
		{
			...
			if (_inputController.LookMode == LookModes.Cursor || _inputController.MoveEnabled == false)
			{
		...
		private void JumpAndGravity()
		{
			...
			if (UseGravity == true && _verticalVelocity < _terminalVelocity)
			{
